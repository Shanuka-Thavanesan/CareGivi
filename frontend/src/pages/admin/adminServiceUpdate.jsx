...
const handletitleChange = (e) => {
  ...
  const uploadHandler = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`http://localhost:5000/api/v1/services/update/${id}`,
    ...
    <section className="mb-12 ">
      <div className="w-full max-w-xl mx-auto mt-12 border border-yellowGreen border-4 rounded-md px-6 py-6 filter drop-shadow-md md:drop-shadow-xl ">
        <form onSubmit={(e) => uploadHandler(e)}>
          ...
          <h2 className="text-2xl font-bold mb-2 text-primaryColor filter drop-shadow-md md:drop-shadow-xl text-center">Service Update </h2>
          <div className="mb-8">
